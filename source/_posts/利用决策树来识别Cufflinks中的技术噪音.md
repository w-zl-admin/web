...
$$Max(IG(A\_i))=Max(H(U)-H(U|A))=$$

$$Max(P\_A(P\_{(\oplus|A)}logP\_{(\oplus|A)}+P\_{(\ominus|A)}logP\_{(\ominus|A)})+(1-P\_A)(P\_{(\oplus|A')}logP\_{(\oplus|A')}+P\_{(\ominus|A')}logP\_{(\ominus|A')})-P\_{\oplus}logP\_{\oplus}-P\_{\ominus}logP\_{\ominus})$$
**实例**
